            ...
            <div className="relative">
              ...
              <div className="relative bg-card border rounded-2xl p-8 shadow-2xl">
                ...
                <div className="space-y-4">
                  {[
                    { time: "10:00 AM", place: "Fushimi Inari Taisha", desc: "Hike through thousands of vibrant vermilion torii gates." },
                    { time: "1:00 PM", place: "Lunch at Nishiki Market", desc: "Sample local street food like tamagoyaki and takoyaki." },
                    { time: "3:30 PM", place: "Kiyomizu-dera Temple", desc: "Iconic wooden temple offering sweeping city views." },
                  ].map((item, i) => (
                    <div key={i} className="p-4 rounded-lg border bg-card shadow-sm">
                      <p className="font-medium text-sm">{item.time}</p>
                      <p className="font-bold mt-1">{item.place}</p>
      ...
      <section className="py-24 bg-primary text-primary-foreground">
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              { quote: "Planned a 2-week honeymoon in Italy in literally 5 minutes. The hotel recommendations were spot on for our budget, and the daily pacing was perfect.", name: "Sarah M.", role: "Honeymooner", initials: "SM" },
              { quote: "I travel for work and usually just wing it on weekends. Now I use this to generate weekend itineraries. It finds the weird, cool local spots I'd never find alone.", name: "James D.", role: "Digital Nomad", initials: "JD" },
              { quote: "The budget breakdown feature is a lifesaver. It showed us we were underestimating transport costs in Switzerland before we even booked our flights.", name: "Alex & Taylor", role: "Budget Travelers", initials: "AT" },
            ].map((review, i) => (
              <div key={i} className="bg-primary-foreground/10 p-8 rounded-2xl backdrop-blur-sm border border-primary-foreground/20">
                <Quote className="w-8 h-8 opacity-50 mb-4" />
                <p className="text-lg mb-6 leading-relaxed">&ldquo;{review.quote}&rdquo;</p>
                <div className="flex items-center gap-4">
                  <div className="w-10 h-10 rounded-full bg-primary-foreground/20 flex items-center justify-center font-bold">{review.initials}</div>
                  <div>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <div className="bg-card border rounded-2xl p-8 shadow-sm flex flex-col">
              ...
              <ul className="space-y-4 mb-8 flex-1">
                <li className="flex items-center gap-3"><Check className="w-5 h-5 text-primary" /> 3 AI trip generations per month</li>
                <li className="flex items-center gap-3"><Check className="w-5 h-5 text-primary" /> Basic day-by-day itineraries</li>
                <li className="flex items-center gap-3"><Check className="w-5 h-5 text-primary" /> Standard budget estimations</li>
              </ul>
            ...
            <div className="bg-primary text-primary-foreground rounded-2xl p-8 shadow-xl flex flex-col relative transform md:-translate-y-4">
              <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-accent text-accent-foreground px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wider">Most Popular</div>
              ...
              <div className="mb-6"><span className="text-4xl font-bold">$12</span><span className="text-primary-foreground/80">/mo</span></div>
              <ul className="space-y-4 mb-8 flex-1">
                <li className="flex items-center gap-3"><Check className="w-5 h-5 text-accent" /> Unlimited AI trip generations</li>
                <li className="flex items-center gap-3"><Check className="w-5 h-5 text-accent" /> Hyper-personalized itineraries</li>
                <li className="flex items-center gap-3"><Check className="w-5 h-5 text-accent" /> Advanced budget tools</li>
                <li className="flex items-center gap-3"><Check className="w-5 h-5 text-accent" /> Save & export to PDF</li>
              </ul>
            ...
            <div className="bg-card border rounded-2xl p-8 shadow-sm flex flex-col">
              ...
              <ul className="space-y-4 mb-8 flex-1">
                ...
                <li className="flex items-center gap-3"><Check className="w-5 h-5 text-primary" /> Custom branding on exports</li>
                <li className="flex items-center gap-3"><Check className="w-5 h-5 text-primary" /> Client collaboration tools</li>
        ...
        <div className="container mx-auto px-4 md:px-6 max-w-3xl">
          ...
          <Accordion type="single" collapsible className="w-full bg-card rounded-2xl border p-4 shadow-sm">
            <AccordionItem value="item-1">
              ...
              <AccordionContent className="text-muted-foreground text-base leading-relaxed">Our AI analyzes millions of data points including travel blogs, review sites, weather patterns, and local pricing. It generates a realistic, logically-paced daily schedule around your constraints.</AccordionContent>
            </AccordionItem>
            <AccordionItem value="item-2">
              <AccordionTrigger className="text-left font-semibold text-lg">Are the budget estimates accurate?</AccordionTrigger>
              <AccordionContent className="text-muted-foreground text-base leading-relaxed">Yes, we constantly update our pricing models. These are estimates for planning purposes — flight costs are excluded as they vary based on origin.</AccordionContent>
            </AccordionItem>
            <AccordionItem value="item-3">
              <AccordionTrigger className="text-left font-semibold text-lg">Can I modify a generated trip?</AccordionTrigger>
              <AccordionContent className="text-muted-foreground text-base leading-relaxed">Currently you can save and view your trips. Full editing capabilities are coming in our next major update for Pro users.</AccordionContent>
            </AccordionItem>
            <AccordionItem value="item-4">
              <AccordionTrigger className="text-left font-semibold text-lg">Do you actually book hotels and flights?</AccordionTrigger>
              <AccordionContent className="text-muted-foreground text-base leading-relaxed">TripGeniee is a planning tool, not a booking agency. We provide the ideal blueprint — you use your preferred booking platforms to finalize reservations.</AccordionContent>
            </AccordionItem>
          </Accordion>
        </div>
      </section>
